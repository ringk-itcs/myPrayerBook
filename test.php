...
/*
        $sql = sprintf(
            "SELECT DISTINCT SQL_CALC_FOUND_ROWS
                    ...
                    IF(cj.candidate_joborder_id, 1, 0) AS submitted,
                    IF(attachment_id, 1, 0) AS attachmentPresent,
                    ...
                    DATE_FORMAT(c.date_created, '%d-%m-%y') AS dateCreated,
                    DATE_FORMAT(c.date_modified, '%d-%m-%y') AS dateModified
                FROM  candidate c
               ...
               WHERE  cj.candidate_id = c.candidate_id
                 ...
                 AND c.candidate_id = a.data_item_id
